  ...
  return (
    <div className={styles.termsWrapper}>
      ...
      <div className={styles.textWrapper}>
        <Typography className={styles.title}>MZer, LLC User Terms of Use</Typography>
        <div className={styles.article}>
          <Typography variant={'h6'} className={styles.text}>
            MZ, LLC, a Limited Liability Company organized under the laws of the State of Florida and
            headquartered in Tampa (”MZer” or “we” or “us” or “our”) welcomes you. References to MZer include
            any subsidiaries or affiliates of MZer involved with providing our Services. We invite you to access
